...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_K, KC_M, TH_UM_ACOMM, TH_UM_AECOMM, TH_UM_OCOMM, KC_NO, LT(_MSE,KC_ESC), LT(_NAV,KC_SPC), OSM(MOD_LSFT), KC_ENT, LT(_NUM,KC_BSPC), LT(_SYM,KC_DEL)),

    [_NAV] = LAYOUT_split_3x6_3(KC_NO, LSFT(KC_TAB), KC_TAB, PREV_TAB, NEXT_TAB, SCRNSHT, KC_PGUP, KC_H, KC_J, KC_K, KC_L, KC_NO, KC_NO, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_NO, KC_PGDN, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_NO, KC_UNDO, KC_CUT, KC_COPY, KC_PSTE, M_SPST, KC_HOME, KC_NO, KC_NO, KC_NO, KC_END, KC_NO, KC_NO, KC_NO, KC_NO, KC_ENT, BSPC_WRD, DEL_WRD),

	[_NUM] = LAYOUT_split_3x6_3(KC_NO, QK_BOOT, KC_7, KC_8, KC_9, KC_VOLU, KC_MNXT, KC_NO, RGB_SAI, RGB_SPI, RGB_MOD, KC_NO, KC_NO, KC_NO, KC_4, KC_5, KC_6, KC_VOLD, KC_MPLY, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_NO, KC_NO, AS_TOGG, KC_1, KC_2, KC_3, KC_DOT, KC_MPRV, CW_TOGG, RGB_HUI, RGB_VAI, RGB_TOG, KC_NO, KC_EQL, KC_0, KC_MINS, KC_NO, KC_NO, KC_NO),
	[_SYM] = LAYOUT_split_3x6_3(KC_NO, KC_PERC, KC_CIRC, KC_DLR, US_EUR, TH_CLNS, KC_NO, KC_LCBR, KC_RCBR, KC_AT, KC_HASH, KC_NO, KC_NO, KC_SLSH, KC_ASTR, KC_MINS, KC_PLUS, KC_PIPE, KC_NO, KC_LPRN, KC_RPRN, KC_LT, KC_GT, KC_NO, KC_NO, KC_BSLS, KC_AMPR, KC_EXLM, KC_EQL, KC_UNDS, KC_NO, KC_LBRC, KC_RBRC, KC_TILD, KC_GRV, KC_NO, KC_ESC, KC_SPC, KC_TAB, KC_NO, KC_NO, KC_NO),

	[_MSE] = LAYOUT_split_3x6_3(KC_NO, KC_F12, KC_F7, KC_F8, KC_F9, KC_NO, KC_WH_U, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_F4, KC_F5, KC_F6, KC_NO, KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_NO, KC_NO, TG(5), KC_F1, KC_F2, KC_F3, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_BTN2, KC_BTN1, KC_BTN3),

	[_GAM] = LAYOUT_split_3x6_3(KC_NO, KC_Q, KC_W, KC_F, KC_P, KC_G, KC_J, KC_L, KC_U, KC_Y, KC_QUOT, KC_NO, KC_NO, KC_A, KC_R, KC_S, KC_T, KC_D, KC_H, KC_N, KC_E, KC_I, KC_O, KC_NO, KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_K, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_NO, LT(4,KC_ESC), LT(1,KC_SPC), KC_LSFT, KC_ENT, LT(2,KC_BSPC), TG(5))
};
// clang-format on
